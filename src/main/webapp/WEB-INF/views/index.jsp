  ...
  <body>
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div id="interactionBtnsDiv" class="navbar-form navbar-right"> <!-- A small hack to align the buttons vertically and horizontally for the time being -->
			 ...
			 <a href="signin.html" class="btn btn-primary btn-sm" role="button">Sign In</a>
			 <a href="signup.html" class="btn btn-primary btn-sm" role="button">Join</a>  
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Graphical stories go here</h1>
